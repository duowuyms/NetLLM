...
def create_model(model_name, dataset_type, his_window, fut_window, device, seed):
    model = None
    if model_name == 'regression':
        model = create_linear_regression(dataset_type, his_window, fut_window, device, seed)
